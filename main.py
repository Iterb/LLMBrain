...
def main():
    ...
    for chunk in chunks:
        ...
        print(response)
        response = reasoning_unit.bottom_level_reason(chunk, model, "Artificial Intelligence", "Machine learning")
        print(response)
        response = reasoning_unit.bottom_level_reason(chunk, model, "Research", "Scientific inquiry")
        print(response)
        response = reasoning_unit.bottom_level_reason(chunk, model, "Technology", "Autonomous Systems")
        print(response)
        response = reasoning_unit.bottom_level_reason(chunk, model, "Artificial Intelligence", "OpenAI")
        print(response)
        break
